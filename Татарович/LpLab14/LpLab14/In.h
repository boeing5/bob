...
/*0*/IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::E, IN::F, IN::F, IN::F, IN::F, IN::F,\
...
namespace In
{
	struct IN
	{
		enum { E=512, T = 1024, F = 2048, I = 4096 };
		int size; 
		int lines;
		int ignor;
		unsigned char* text;
	...
	IN getin(wchar_t infile[], std::ofstream* stream, void (f)(int,int,int,std::ofstream*));
}